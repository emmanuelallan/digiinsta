...
export const metadata: Metadata = {
  title: "Sale | Special Offers & Discounts",
  description:
            ...
            <div className="py-12">
              <div className="mx-auto max-w-md text-center">
                <div className="bg-muted mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full">
                  <HugeiconsIcon icon={SaleTag01Icon} size={32} className="text-muted-foreground" />
                </div>
        ...
        <section className="border-t bg-gradient-to-r from-rose-50 to-pink-50 py-12 lg:py-16 dark:from-rose-950/20 dark:to-pink-950/20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="text-muted-foreground mt-2">
                Check out our bundles for the best value. Get multiple products at a fraction of the
                price.
              </p>
