...
export const metadata: Metadata = {
  title: "Best Sellers | Top-Rated Digital Products",
  description:
    "Shop DigiInsta's most popular digital products loved by thousands. Proven planners, templates, and tools that deliver real results.",
  alternates: {
    canonical: `${SITE_URL}/best-sellers`,
  },
  openGraph: {
    title: `Best Sellers | ${SITE_NAME}`,
    description:
...
export default async function BestSellersPage() {
  ...
  const productListSchema = getProductListSchema(products, "Best Sellers");
