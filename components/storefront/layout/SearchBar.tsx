...
// Create a context to allow opening search from anywhere
...
export function SearchProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <SearchContext.Provider value={{ openSearch, closeSearch }}>
      {children}
      <SearchDialogContent open={open} onOpenChange={setOpen} />
                ...
                {results.products.map((product) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-muted-foreground text-xs">{product.subcategory?.title}</p>
                    </div>
                  </CommandItem>
                ))}
              </CommandGroup>
